...
def insert_smell_data_in_neo4j(df_metrics):
    ...
    df_metrics = pd.concat([df_metrics, pd.DataFrame([{'source': 'crowdsourced_data', 'nodes': total_nodes, 'edges': total_edges}])], ignore_index=True)
...
def insert_esdr_3_neo4j(df_metrics):
...
def insert_esdr_23_neo4j(df_metrics):
...
def insert_esdr_24_neo4j(df_metrics):
...
def insert_esdr_26_neo4j(df_metrics):
...
def insert_esdr_27_neo4j(df_metrics):
...
def insert_esdr_28_neo4j(df_metrics):
...
def insert_esdr_29_neo4j(df_metrics):
...
def insert_esdr_43_neo4j(df_metrics):
...
def insert_esdr_3506_neo4j(df_metrics):
...
def insert_esdr_3508_neo4j(df_metrics):
...
def insert_esdr_5975_neo4j(df_metrics):
